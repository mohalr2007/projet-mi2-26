...
export function AnimatedButton({
  ...
  const variants = {
    ...
    secondary: "py-2 px-4 border border-gray-300 rounded-2xl text-gray-700 hover:border-gray-400 hover:bg-gray-50 text-sm font-medium",
    social: "py-4 px-4 border-2 border-gray-200 rounded-2xl text-black hover:border-gray-300 hover:bg-gray-50 hover:shadow-md flex items-center justify-center gap-2 text-sm font-medium",
    link: "text-sm text-blue-600 hover:text-blue-700 transition-colors whitespace-nowrap"
  };
