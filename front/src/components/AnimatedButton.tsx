...
export function AnimatedButton({
  ...
  const baseStyles = "relative overflow-hidden font-medium transition-all duration-300 transform disabled:opacity-60 disabled:cursor-not-allowed";
  ...
  const variants = {
    ...
    secondary: "py-2 px-4 border border-gray-300 dark:border-slate-700 rounded-2xl text-gray-700 dark:text-slate-300 hover:border-gray-400 dark:hover:border-slate-500 hover:bg-gray-50 dark:hover:bg-slate-800 text-sm font-medium",
