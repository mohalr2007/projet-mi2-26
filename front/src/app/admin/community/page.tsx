    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center px-4">
        <div className="w-full max-w-lg rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 text-center">
          <p className="text-lg font-semibold text-slate-900 dark:text-slate-100">Accès refusé</p>
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Cette zone est réservée aux modérateurs plateforme.</p>
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-4 sm:p-6">
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <section className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm">
          <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-4">Signalements publications ({postReports.length})</h2>
          <div className="space-y-3">
            {postReports.length === 0 ? <p className="text-sm text-slate-500 dark:text-slate-400">Aucun signalement.</p> : null}
        ...
        <section className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm">
          <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-4">Signalements commentaires ({commentReports.length})</h2>
          <div className="space-y-3">
            {commentReports.length === 0 ? <p className="text-sm text-slate-500 dark:text-slate-400">Aucun signalement.</p> : null}
